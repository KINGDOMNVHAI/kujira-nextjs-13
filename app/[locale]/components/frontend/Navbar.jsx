...
<button class="scroll__top scroll-to-target pl-1" data-target="html">
                <FaArrowUp size={20} />
            </button>
                                ...
                                <div class="tgmenu__wrap">
                                    <nav class="tgmenu__nav">
                                        ...
                                        <div class="tgmenu__navbar-wrap tgmenu__main-menu d-none d-xl-flex">
                                            <ul class="navigation">
                                                <li class="active menu-item-has-children"><a href="#">Home &nbsp; <FaChevronDown/></a>
                                                ...
                                                <li class="menu-item-has-children"><a href="#">Courses &nbsp; <FaChevronDown/></a>
                                                    <ul class="sub-menu">
                                                ...
                                                <li class="menu-item-has-children"><a href="#">Pages &nbsp; <FaChevronDown/></a>
                                                    <ul class="sub-menu">
                                                        <li>
                                                ...
                                                <li class="menu-item-has-children"><a href="#">Dashboard &nbsp; <FaChevronDown/></a>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item-has-children">
                                        ...
                                        <div class="tgmenu__search d-none d-md-block">
                                            <form action="#" class="tgmenu__search-form">
                                                <div class="select-grp">
                                                    ...
                                                    <select class="form-select" id="course-cat" aria-label="Default select example" width={150}>
